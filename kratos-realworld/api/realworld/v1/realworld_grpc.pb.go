...
type RealWorldClient interface {
	...
	GetCurrentUser(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UserReply, error)
	...
	GetTags(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TagListReply, error)
}
...
func (c *realWorldClient) GetCurrentUser(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
...
func (c *realWorldClient) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *realWorldClient) GetTags(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*TagListReply, error) {
...
type RealWorldServer interface {
	...
	GetCurrentUser(context.Context, *empty.Empty) (*UserReply, error)
	...
	GetTags(context.Context, *empty.Empty) (*TagListReply, error)
...
func (UnimplementedRealWorldServer) GetCurrentUser(context.Context, *empty.Empty) (*UserReply, error) {
...
func (UnimplementedRealWorldServer) DeleteComment(context.Context, *DeleteCommentRequest) (*empty.Empty, error) {
...
func (UnimplementedRealWorldServer) GetTags(context.Context, *empty.Empty) (*TagListReply, error) {
