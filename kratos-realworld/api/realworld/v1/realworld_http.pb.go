...
type RealWorldHTTPClient interface {
	...
	GetCurrentUser(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *UserReply, err error)
	GetProfile(ctx context.Context, req *GetProfileRequest, opts ...http.CallOption) (rsp *ProfileReply, err error)
	GetTags(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *TagListReply, err error)
...
func (c *RealWorldHTTPClientImpl) DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
...
func (c *RealWorldHTTPClientImpl) GetCurrentUser(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*UserReply, error) {
	var out UserReply
	pattern := "/api/user"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*TagListReply, error) {
